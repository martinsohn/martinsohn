...
- X [@martinsohndk](https://twitter.com/martinsohndk)
- Bluesky [@martinsohn.dk](https://bsky.app/profile/martinsohn.dk)
- LinkedIn [@martinsohn](https://www.linkedin.com/in/martinsohn)
- GitHub [@martinsohn](https://github.com/MartinSohn)
...
- Series: SID filter as security boundary between domains? (collab w/ [Jonas Bülow Knudsen](https://github.com/JonasBK) & [Tobias Torp](https://www.linkedin.com/in/tobias-torp/))
    ...
    - 2022-04-04, [Part 4: Bypass SID filtering research](https://itm8.com/articles/sid-filter-as-security-boundary-between-domains-part-4)
    - 2022-04-06, [Part 5: Golden GMSA trust attack - from child to parent](https://itm8.com/articles/sid-filter-as-security-boundary-between-domains-part-5)
    - 2022-04-07, [Part 6: Schema change trust attack - from child to parent](https://itm8.com/articles/sid-filter-as-security-boundary-between-domains-part-6)
    - 2022-04-08, [Part 7: Trust account attack - from trusting to trusted](https://itm8.com/articles/sid-filter-as-security-boundary-between-domains-part-7)
- 2022-03-17, [Privilege escalation vulnerability in Anaconda3 and Miniconda3](https://itm8.com/articles/privilege-escalation-vulnerability-in-anaconda3-and-miniconda3) - CVE-2022-26526
...
- Multiple vendors - [RTFM: Read The Fatal Manual – When Vendor Documentation Creates Critical Attack Paths](https://specterops.io/blog/2026/03/24/rtfm-read-the-fatal-manual-when-vendor-documentation-creates-critical-attack-paths/)
    - [CyberArk CA25-38](https://community.cyberark.com/s/feed/0D5Vy00001oD7i3KAC): Critical severity issue in the "Manage AD certificates in the devices" section of CyberArk Identity documentation
    - [ManageEngine security advisory](https://www.manageengine.com/mobile-device-management/help/certificate_management/ad_cs_certificate_template_guidance.html): Corrected AD CS certificate template guidance
- PeaZip - [Local privilege escalation vulnerabilities in PeaZip MSI installer](https://itm8.com/articles/local-privilege-escalation-vulnerabilities-in-peazip-msi-installer)
    - [CVE-2022-40779](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-40779): Privilege escalation in PeaZip version 8.8.0 MSI installer due to EXEMSI vulnerability
    - [CVE-2022-47082](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-47082): Privilege escalation in PeaZip version 8.8.0 MSI Installer due to incorrect access control
- Anaconda3 and Miniconda3 - [Privilege escalation vulnerability in Anaconda3 and Miniconda3](https://itm8.com/articles/privilege-escalation-vulnerability-in-anaconda3-and-miniconda3)
    - [CVE-2022-26526](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-26526): Privilege escalation in Anaconda3 v2021.11.0.0 and Miniconda3 v11.0.0.0
- NinjaRMM Agent - [Privilege escalation vulnerability in NinjaRMM Agent MSI Installer introduced by EXEMSI MSI Wrapper](https://itm8.com/articles/privilege-escalation-vulnerability-in-ninjarmm-agent-msi-installer-introduced-by-exemsi-msi-wrapper)
    - [CVE-2021-26273](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-26273): Privilege escalation in NinjaRMM Agent v5.0.909
    - [CVE-2021-26274](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-26274): Insecure installation folder permissions in NinjaRMM Agent v5.0.909
    - [CVE-2021-32415](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-32415): EXEMSI MSI Wrapper Versions prior to 10.0.50 and at least since version 6.0.91 will introduce a local privilege escalation vulnerability in installers it creates.
